...
export const LOG_CONFIG = {
  ...
  redactKeys: (process.env.LOG_REDACT_KEYS ||
    'password,token,apikey,authorization,cookie,secret,credential,signature,bearer,jwt,privatekey,accesskey,sessiontoken')
    .split(',')
